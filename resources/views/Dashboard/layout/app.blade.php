...
<head>
    ...
    <!-- Material Kit CSS -->
    <link href="{{asset('Dashboard/assets/css/material-dashboard.css?v=2.1.0')}}" rel="stylesheet" />
    @stack('css')
</head>
...
<script src="{{asset('Dashboard/assets/js/material-dashboard.js?v=2.1.0')}}"></script>
