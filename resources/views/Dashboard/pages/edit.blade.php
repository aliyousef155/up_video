        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header card-header-primary">
                    ...
                    <p class="card-category">here you can edit pages</p>
                </div>
{{--                end of card header--}}
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input type="text" class="form-control @error('meta_keyword') is-invalid @enderror" name="meta_keywords" value="{{$row->meta_keywords}}">
                                    @error('meta_keywords')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <textarea name="meta_description" class="form-control @error('meta_keyword') is-invalid @enderror" >{{$row->meta_description}}</textarea>
